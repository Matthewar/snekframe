...
class _StyleGenerator:
    def generate(self):
        ...
        styles.configure(
            "TLabel",
            background=DEFAULT_BACKGROUND_COLOUR.string,
            foreground="#000000",
            font="DefaultFont",
        )
        styles.configure(
            "TButton",
            background=HIGHLIGHT_BACKGROUND_COLOUR.string,
            foreground=FONT_COLOUR.string,
            font="DefaultFont",
        )

        styles.configure(
            "Default.Button.TFrame",
            background=HIGHLIGHT_BACKGROUND_COLOUR.string,
            foreground=FONT_COLOUR.string,
        )
        ...
        styles.configure(
            "Selected.Default.Button.TFrame", background="#ffffff", foreground="#000000"
        )

        styles.configure(
            "Default.Button.TLabel",
            background=HIGHLIGHT_BACKGROUND_COLOUR.string,
            foreground=FONT_COLOUR.string,
        )
        ...
        styles.configure(
            "Selected.Default.Button.TLabel", background="#ffffff", foreground="#000000"
        )

        styles.configure(
            "Default.Icon.Button.TLabel", background=DEFAULT_BACKGROUND_COLOUR.string
        )
        styles.configure(
            "Title.Icon.Button.TLabel", background=HIGHLIGHT_BACKGROUND_COLOUR.string
        )
        ...
        styles.configure(
            "Active.Default.IconText.Button.TLabel", background=Colour(0xFFFFFF).string
        )
        styles.configure(
            "Disabled.Default.IconText.Button.TLabel",
            background=Colour(0x000000).string,
        )
        styles.configure(
            "Selected.Default.IconText.Button.TLabel",
            background=Colour(0xFFFFFF).string,
            foreground=Colour(0xABB0B8).string,
        )
        styles.configure(
            "Default.IconText.Button.TFrame",
            background=DEFAULT_BACKGROUND_COLOUR.string,
        )
        styles.configure(
            "Active.Default.IconText.Button.TFrame", background=Colour(0xFFFFFF).string
        )
        styles.configure(
            "Disabled.Default.IconText.Button.TFrame",
            background=Colour(0x000000).string,
        )
        styles.configure(
            "Selected.Default.IconText.Button.TFrame",
            background=Colour(0xFFFFFF).string,
            foreground="#abb0b8",
        )

        styles.configure(
            "DisplayWindow.TFrame", background=PHOTO_BACKGROUND_COLOUR.string
        )
        styles.configure(
            "Image.DisplayWindow.TLabel", background=PHOTO_BACKGROUND_COLOUR.string
        )
        styles.configure(
            "TitleBar.TFrame", background=HIGHLIGHT_BACKGROUND_COLOUR.string
        )
        styles.configure(
            "TitleBar.TLabel",
            background=HIGHLIGHT_BACKGROUND_COLOUR.string,
